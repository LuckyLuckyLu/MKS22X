...
public class MyLinkedListImproved<T extends Comparable<T>> implements Iterable<T>{
  ...
  public void extend(MyLinkedListImproved<T> data){
    ...
    this.getNode(size()-1).setNex(data.getNode(0));
    this.end = data.end;
    data.clear();
  }
  ...
  public class Sorts{
    public void radixsort(MyLinkedListImproved<Integer> data){
      ...
      for(int i = 1; i < maxValue; i= i*10){
        System.out.println(maxValue/(10*i));
      }
  ...
  public static void main(String[] args){
    ...
    MyLinkedListImproved<Integer> y = new MyLinkedListImproved<>();
  }
}
